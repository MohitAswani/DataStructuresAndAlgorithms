...
/**
 * @brief We perform level order traversal and keep on storing the nodes with a new hd in map and in this way we get the first node for every level and hence the top view.
 *
