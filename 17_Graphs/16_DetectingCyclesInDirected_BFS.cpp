 ...
 * So cycles are present in directed graphs if in the same call of BFS_Helper function we detect vertices which
 we already visited. (Or if we detect a back edges )
