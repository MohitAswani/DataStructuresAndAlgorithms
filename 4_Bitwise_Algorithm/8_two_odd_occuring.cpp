...
void two_odd(vector<int> v)
{
    ...
    The first set bit of xor represents the difference between the two odd occuring element. That bit will be set in one number and not in the other so we find them by using this concept
